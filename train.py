...
model.train(train_dataset, val_dataset, learning_rate=config.LEARNING_RATE / 10, epochs=35, layers='4+', augmentation=augmentation)
model.train(train_dataset, val_dataset, learning_rate=config.LEARNING_RATE / 10, epochs=60, layers='all', augmentation=augmentation)